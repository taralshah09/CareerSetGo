    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thread', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='thread_posts', to='myapp.thread')),
            ],
        ),
        migrations.CreateModel(
            name='Pin',
            fields=[
                ...
                ('thread', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='thread_pin', to='myapp.thread')),
            ],
        ),
        migrations.CreateModel(
            name='AppliedJob',
