...
from .views import ( RegisterUser,LoginView,LogoutView,UpdateProfile,UserProfileView,CurrentUserView,PostJobView,RecentJobsView,AddToWishlistView,fetchcourses)
